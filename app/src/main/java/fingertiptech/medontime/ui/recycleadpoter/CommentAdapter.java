...
public class CommentAdapter extends RecyclerView.Adapter<CommentAdapter.CommentHolder> {
    ...
    Context context;
    List<TestComment> commentList;

    public CommentAdapter(Context context , List<TestComment> commentList){
    ...
    public CommentHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.test_each_comment , parent , false);
    ...
    public void onBindViewHolder(@NonNull CommentHolder holder, int position) {
        ...
        TestComment comment = commentList.get(position);
