...
public class MainActivity extends AppCompatActivity implements ScanNFCTagFragment.OnDataPass {
    ...
    // TODO: Figure out how to create fragment UI events in MainActivity.java
    @Override
    public void onDataPass(String data) {
        Log.d("LOG","hello " + data);
        ScanNFCTagFragment test = (ScanNFCTagFragment) getSupportFragmentManager().findFragmentByTag("scan_nfc_tag_fragment");
